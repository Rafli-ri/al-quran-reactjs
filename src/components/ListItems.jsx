...
const ListItems = ({
  ...
  return (
    <Link
      to={`/surat/${nomor}`}
      className="w-full md:px-5 mt-2 sm:py-2 md:w-1/2 xl:w-1/3"
    >
      <div className="flex items-center content-center px-4 py-6 shadow-sm rounded-md bg-white hover:shadow-[0_20px_15px_-20px_rgba(68,68,68,0.45)] hover:-translate-y-1 hover:duration-[250ms] hover:cursor-pointer">
